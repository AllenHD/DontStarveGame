...
Inv = Class(Widget, function(self, owner)
    ...
    local equip_slots = {EQUIPSLOTS.HANDS, EQUIPSLOTS.BODY, EQUIPSLOTS.HEAD, EQUIPSLOTS.BACK} -- mod change
    local bgs = {"images/equip_slot.tex", "images/equip_slot_body.tex", "images/equip_slot_head.tex", "images/equip_slot_back.tex"} -- mod change
