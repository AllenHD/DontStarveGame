...
local HUD_ATLAS = "data/images/hud.xml"
...
RecipePopup = Class(Widget, function(self, parentslot)
    ...
    self.button:SetImage("data/images/ui.xml", "button.tex")
    self.button:SetMouseOverImage("data/images/ui.xml", "button_over.tex")
    self.button:SetDisabledImage("data/images/ui.xml", "button_disabled.tex")
...
CraftSlot = Class(Widget, function(self, atlas, bgim, owner)
	...
	self.fgimage = self:AddChild(Image("data/images/hud.xml", "craft_slot_locked.tex"))
    self.fgimage:Hide()
...
CraftTabs = Class(Widget, function(self, owner)
    ...
    self.crafting:Hide()
    self.bg = self:AddChild(Image("data/images/hud.xml", "craft_bg.tex"))
    ...
    for k,v in ipairs(tabnames) do
        local tab = self.tabs:AddTab(v.str, resolvefilepath("data/images/hud.xml"), v.icon_atlas or resolvefilepath("data/images/hud.xml"), v.icon, tab_bg.normal, tab_bg.selected, tab_bg.highlight, tab_bg.overlay,
            function() --select fn
