        ...
        timeline=
        {
            ...
            TimeEvent(10*FRAMES, function(inst)
                if inst.prefab == "woodie" and
                   (TheInput:IsMouseDown(MOUSEBUTTON_LEFT) or TheInput:IsKeyDown(KEY_SPACE)) and 
   ...
   State{
    ...
    State{
        ...
        onenter = function(inst)
            ...
            local colour = colourizefx(inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HANDS))
        ...
        timeline = 
        {
            TimeEvent(13*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/common/staffteleport") end),
