...
local assets = 
{
    Asset("ANIM", "data/anim/woodie.zip"),
	Asset("SOUND", "data/sound/woodie.fsb"),
    
    Asset("ANIM", "data/anim/werebeaver_build.zip"),
    Asset("ANIM", "data/anim/werebeaver_basic.zip"),
    Asset("ANIM", "data/anim/player_woodie.zip"),
    Asset("ATLAS", "data/images/woodie.xml"),
    Asset("IMAGE", "data/images/woodie.tex"),
    Asset("IMAGE", "data/images/colour_cubes/beaver_vision_cc.tex"),
...
local function SetHUDState(inst)
	if inst.HUD then
		if inst.components.beaverness:IsBeaver() and not inst.HUD.controls.beaverbadge then
		    ...
		    inst.HUD.beaverOL = inst.HUD.under_root:AddChild(Image("data/images/woodie.xml", "beaver_vision_OL.tex"))
