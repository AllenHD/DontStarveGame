...
local function KeepTarget(inst, target)
    ...
    if (inst.components.teamattacker.teamleader
        and not inst.components.teamattacker.teamleader:CanAttack())
...
local function OnAttacked(inst, data)
    ...
    dprint("OnAttacked")
    if not inst.components.teamattacker or not inst.components.teamattacker then return end
...
local function fn()
    ...
    inst:ListenForEvent("hostileprojectile", OnAttacked)
