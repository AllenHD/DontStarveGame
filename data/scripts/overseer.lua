...
-- times get reset moving into and out of caves
...
TheInput:AddMouseButtonHandler( MOUSEBUTTON_LEFT, true, UpdateInputTime )
TheInput:AddMouseButtonHandler( MOUSEBUTTON_SCROLLUP, true, UpdateInputTime )
TheInput:AddMouseButtonHandler( MOUSEBUTTON_SCROLLDOWN, true, UpdateInputTime )
TheInput:AddMouseMoveHandler( MouseMoveCheck )
